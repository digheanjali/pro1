...
describe('verify the radio Button', function () {
    ...
    it.only('verify the functionality of check box with loop', function () {
        cy.get('input[type="checkbox"]').each(function (el) {
            cy.wrap(el).check().should('be.checked')
            cy.wrap(el).uncheck().should('not.be.checked')
    ...
    it.only('verify the functionality of check box with click', function () {
        ...
        it.only('verify the functionality of check box - multiple', function () {
